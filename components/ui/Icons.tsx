...
export const Icons = {
  ...
  Timer: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="10" x2="14" y1="2" y2="2"/><line x1="12" x2="12" y1="6" y2="14"/><circle cx="12" cy="14" r="8"/></svg>
  ),
  ...
  BrainCircuit: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5a3 3 0 1 0-5.993.129"/><path d="M12 5a3 3 0 1 1 5.993.129"/><path d="M15 12a3 3 0 1 0-5.993.129"/><path d="M15 12a3 3 0 1 1 5.993.129"/><path d="M9 12a3 3 0 1 0-5.993.129"/><path d="M9 12a3 3 0 1 1 5.993.129"/><path d="M12 19a3 3 0 1 0-5.993.129"/><path d="M12 19a3 3 0 1 1 5.993.129"/><path d="M16 8.5a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0Z"/><path d="M17 15.5a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0Z"/><path d="M8 8.5a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0Z"/><path d="M7 15.5a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0Z"/><path d="M12 12.5a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0Z"/><path d="M12 19.5a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0Z"/><path d="M12 4.5a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0Z"/><path d="M13 5.5c.333.333.5.5.5.5"/><path d="M11 5.5c-.333.333-.5.5-.5.5"/><path d="M13 12.5c.333.333.5.5.5.5"/><path d="M11 12.5c-.333.333-.5.5-.5.5"/><path d="M13 19.5c.333.333.5.5.5.5"/><path d="M11 19.5c-.333.333-.5.5-.5.5"/><path d="M10.5 9c.333.333.5.5.5.5"/><path d="M13.5 9c-.333.333-.5.5-.5.5"/><path d="M10.5 16c.333.333.5.5.5.5"/><path d="M13.5 16c-.333.333-.5.5-.5.5"/></svg>
  ),
  ...
  Dumbbell: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m6.5 6.5 11 11"/><path d="m21 21-1-1"/><path d="m3 3 1 1"/><path d="m18 22 4-4"/><path d="m6 2-4 4"/><path d="m3 10 7-7"/><path d="m14 21 7-7"/></svg>
  ),
  GlassWater: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15.2 22H8.8a2 2 0 0 1-2-1.79L5 3h14l-1.81 17.21A2 2 0 0 1 15.2 22Z"/><path d="M6 12h12"/></svg>
  ),
